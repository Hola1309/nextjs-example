...
import { MAIN_SEO, REQUEST_PRODUCTS_BLOCK, DETAILED_SERVICES_2 } from 'constants/data';
    ...
    <div className={styles.container}>
      ...
      <Page className={cx('MainPage')}>
        <DetailedServicesItem
          items={DETAILED_SERVICES_2.items}
          url={DETAILED_SERVICES_2.url}
          title={DETAILED_SERVICES_2.title}
          serviceId={DETAILED_SERVICES_2.serviceId}
          descriptionItems={DETAILED_SERVICES_2.descriptionItems}
        />
        <RequestProductsForm
