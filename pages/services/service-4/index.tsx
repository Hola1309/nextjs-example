...
import { MAIN_SEO, REQUEST_PRODUCTS_BLOCK, DETAILED_SERVICES_4 } from 'constants/data';
    ...
    <div className={styles.container}>
      ...
      <Page className={cx('MainPage')}>
        <DetailedServicesItem
          items={DETAILED_SERVICES_4.items}
          url={DETAILED_SERVICES_4.url}
          title={DETAILED_SERVICES_4.title}
          serviceId={DETAILED_SERVICES_4.serviceId}
          descriptionItems={DETAILED_SERVICES_4.descriptionItems}
        />
        <RequestProductsForm
