...
const DetailedNewsItem: React.FC<DetailedNewsItemProps> = ({
  url,
  title,
  image,
  section,
  ...
  return (
    <div className={cx('DetailedNewsItem')}>
      <Container className={cx('DetailedNewsItem__container')}>
        ...
        <div className={cx('DetailedNewsItem__imageWrap')}>
          <img className={cx('DetailedNewsItem__image')} src={image} alt={image} />
        </div>
              ...
              <div className={cx('DetailedNewsItem__eventsWrap')}>
                {eventItems.map((eventItem) => (
                  <div className={cx('DetailedNewsItem__eventWrap')} key={eventItem.id}>
                    ...
                    <div className={cx('DetailedNewsItem__eventTitleLink')}>
                      {eventItem.titleLink}
                    </div>
                    <div className={cx('DetailedNewsItem__eventLinkWrap')}>
                      <a href="#" className={cx('DetailedNewsItem__eventLink')}>
                        {eventItem.link}
                      </a>
                    </div>
                    <div className={cx('DetailedNewsItem__eventMainDescription')}>
                      {HTMLParse(eventItem.mainDescription)}
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className={cx('DetailedNewsItem__eventsWrap')}>
                {sliderItems.map((sliderItem) => (
                  <div className={cx('DetailedNewsItem__eventWrap')} key={sliderItem.id}>
                    <div className={cx('DetailedNewsItem__eventTitleLink')}>
                      {sliderItem.titleSlider}
                    </div>
                    <div className={cx('DetailedNewsItem__eventMainDescription')}>
                      {sliderItem.mainDescription}
                    </div>
